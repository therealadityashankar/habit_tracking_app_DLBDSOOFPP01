...
Tests to check if the "amazing meal" habit
1. Can be added
...
complete_test_cli_operations = [
    ...
    "test-amazing meal", # the name of the habit
    "testing having an amazing meal once a week", # the description of the habit
...
class TestAmazingMeal(unittest.TestCase):
    """
    ...
    def step1_habit_creation_weekly_test(self):
        ...
        test-amazing meal
           testing having an amazing meal once a week
           periodicity : weekly
           *no streak yet!""")
    ...
    def step5_habit_deletion_test(self):
        ...
        output_should_not_contain = textwrap.dedent(f"test-amazing meal-renameds")
    ...
    def test_amazing_meal_habit(self, mock_input):
