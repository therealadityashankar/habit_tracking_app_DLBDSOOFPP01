...
Tests to check if the "morning walk" habit
1. Can be added
...
complete_test_cli_operations = [
    ...
    "test-morning walk", # the name of the habit
    "testing going for a morning walk", # the description of the habit
...
class TestMorningWalk(unittest.TestCase):
    """
    ...
    def step1_habit_creation_daily_test(self):
        ...
        test-morning walk
           testing going for a morning walk
           periodicity : daily
           *no streak yet!""")
    ...
    def step6_habit_deletion_test(self):
        ...
        output_should_not_contain = textwrap.dedent(f"test-morning walk-renameds")
    ...
    def test_morning_walk(self, mock_input):
