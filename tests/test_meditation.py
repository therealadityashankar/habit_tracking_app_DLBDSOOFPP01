...
Tests to check if the "meditation" habit
1. Can be added
...
complete_test_cli_operations = [
    ...
    "test-meditation", # the name of the habit
    "testing meditating in the morning", # the description of the habit
...
class TestMeditation(unittest.TestCase):
    ...
    def step1_habit_creation_daily_test(self):
        ...
        test-meditation
           testing meditating in the morning
           periodicity : daily
           *no streak yet!""")
    ...
    def step6_habit_deletion_test(self):
        ...
        output_should_not_contain = textwrap.dedent(f"test-meditation-renameds")
    ...
    def test_meditation(self, mock_input):
